...
TFNSW_VEHICLE_DESCRIPTOR_FIELD_NUMBER: _ClassVar[int]
...
class FeedMessage(_message.Message):
    ...
    def __init__(
        self,
        header: _Optional[_Union[FeedHeader, _Mapping]] = ...,
        entity: _Optional[_Iterable[_Union[FeedEntity, _Mapping]]] = ...,
    ) -> None: ...
...
class FeedHeader(_message.Message):
    ...
    def __init__(
        self,
        gtfs_realtime_version: _Optional[str] = ...,
        incrementality: _Optional[_Union[FeedHeader.Incrementality, str]] = ...,
...
class FeedEntity(_message.Message):
    ...
    def __init__(
        ...
        id: _Optional[str] = ...,
        is_deleted: bool = ...,
        trip_update: _Optional[_Union[TripUpdate, _Mapping]] = ...,
        vehicle: _Optional[_Union[VehiclePosition, _Mapping]] = ...,
...
class TripUpdate(_message.Message):
    ...
    class StopTimeUpdate(_message.Message):
        ...
        def __init__(
            ...
            arrival: _Optional[
                _Union[TripUpdate.StopTimeEvent, _Mapping]
            ] = ...,
            departure: _Optional[
                _Union[TripUpdate.StopTimeEvent, _Mapping]
            ] = ...,
            schedule_relationship: _Optional[
                _Union[TripUpdate.StopTimeUpdate.ScheduleRelationship, str]
            ] = ...,
        ) -> None: ...
    ...
    stop_time_update: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        self,
        trip: _Optional[_Union[TripDescriptor, _Mapping]] = ...,
        vehicle: _Optional[_Union[VehicleDescriptor, _Mapping]] = ...,
        stop_time_update: _Optional[
            _Iterable[_Union[TripUpdate.StopTimeUpdate, _Mapping]]
        ] = ...,
        timestamp: _Optional[int] = ...,
        delay: _Optional[int] = ...,
    ) -> None: ...
...
class VehiclePosition(_message.Message):
    ...
    def __init__(
        ...
        current_stop_sequence: _Optional[int] = ...,
        stop_id: _Optional[str] = ...,
        current_status: _Optional[
            _Union[VehiclePosition.VehicleStopStatus, str]
        ] = ...,
        timestamp: _Optional[int] = ...,
        congestion_level: _Optional[
            _Union[VehiclePosition.CongestionLevel, str]
        ] = ...,
        occupancy_status: _Optional[
            _Union[VehiclePosition.OccupancyStatus, str]
        ] = ...,
    ) -> None: ...
...
class Alert(_message.Message):
    ...
    def __init__(
        self,
        active_period: _Optional[_Iterable[_Union[TimeRange, _Mapping]]] = ...,
        informed_entity: _Optional[
            _Iterable[_Union[EntitySelector, _Mapping]]
        ] = ...,
        cause: _Optional[_Union[Alert.Cause, str]] = ...,
        effect: _Optional[_Union[Alert.Effect, str]] = ...,
        url: _Optional[_Union[TranslatedString, _Mapping]] = ...,
        header_text: _Optional[_Union[TranslatedString, _Mapping]] = ...,
        description_text: _Optional[_Union[TranslatedString, _Mapping]] = ...,
    ) -> None: ...
...
class Position(_message.Message):
    ...
    def __init__(
        ...
        bearing: _Optional[float] = ...,
        odometer: _Optional[float] = ...,
...
class TripDescriptor(_message.Message):
    ...
    def __init__(
        ...
        direction_id: _Optional[int] = ...,
        start_time: _Optional[str] = ...,
        start_date: _Optional[str] = ...,
        schedule_relationship: _Optional[
            _Union[TripDescriptor.ScheduleRelationship, str]
        ] = ...,
    ) -> None: ...
...
class EntitySelector(_message.Message):
    ...
    def __init__(
        self,
        agency_id: _Optional[str] = ...,
        route_id: _Optional[str] = ...,
        route_type: _Optional[int] = ...,
        trip: _Optional[_Union[TripDescriptor, _Mapping]] = ...,
        stop_id: _Optional[str] = ...,
    ) -> None: ...
...
class TranslatedString(_message.Message):
    ...
    class Translation(_message.Message):
        ...
        language: str
        def __init__(
            self, text: _Optional[str] = ..., language: _Optional[str] = ...
        ) -> None: ...

    TRANSLATION_FIELD_NUMBER: _ClassVar[int]
    translation: _containers.RepeatedCompositeFieldContainer[
        TranslatedString.Translation
    ]
    def __init__(
        self,
        translation: _Optional[
            _Iterable[_Union[TranslatedString.Translation, _Mapping]]
        ] = ...,
    ) -> None: ...

class TfnswVehicleDescriptor(_message.Message):
    __slots__ = ("air_conditioned", "wheelchair_accessible")
    AIR_CONDITIONED_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        air_conditioned: bool = ...,
        wheelchair_accessible: _Optional[int] = ...,
    ) -> None: ...
